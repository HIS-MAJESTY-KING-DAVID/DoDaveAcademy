...
export default function MainBarnner(props: any) {
  return (
    <>
<section className="position-relative overflow-hidden pt-5 pt-lg-3 barnner">
        <!-- SVG START -->
        <figure className="position-absolute top-50 start-0 translate-middle-y ms-n7 d-none d-xxl-block">
            <svg className="rotate-74 fill-danger opacity-1">
                ...
                <path d="m57.3 64.5c-1.7 0-3.1-1.4-3.1-3.1s1.4-3.1 3.1-3.1 3.1 1.4 3.1 3.1c0 1.8-1.4 3.1-3.1 3.1z" />
        ...
        <span className="position-absolute top-50 end-0 translate-middle-y mt-5 me-n5 d-none d-xxl-inline-flex">
            <svg className="fill-warning rotate-186 opacity-8">
                ...
                <path d="m42.8 54.2c0 1.7-0.2 3.3-0.7 5-2.7 10.2-13.3 16.3-23.5 13.6-5-1.3-9.1-4.5-11.7-8.9-2.5-4.5-3.2-9.7-1.9-14.7 2.7-10.2 13.3-16.3 23.5-13.6 5 1.3 9.1 4.5 11.7 8.9 1.7 3 2.6 6.3 2.6 9.7zm-38.1 0c0 3.3 0.9 6.5 2.5 9.4 2.5 4.4 6.6 7.5 11.5 8.8 10 2.7 20.4-0.9 23.1-11.9 2.2-5.3 2.1-11.2-0.1-16.5s-6.4-9.4-11.5-8.8c-10-2.6-20.4 0.9-23.1 11.9-0.5 1.6-0.7 3.3-0.7 4.9z" />
                ...
                <path d="m50.7 54.2c0 2.8-0.5 5.6-1.6 8.2-4.5 11.2-17.4 16.6-28.6 12.1-5.4-2.2-9.7-6.4-12-11.8s-2.3-11.4-0.1-16.8c4.5-11.2 17.4-16.6 28.6-12.1 5.4 2.2 9.7 6.4 12 11.8 1.1 2.8 1.7 5.7 1.7 8.6zm-43.6 0c0 2.8 0.6 5.7 1.7 8.4 2.2 5.3 6.4 9.4 11.8 11.6 11 4.5 23.6-0.9 28.1-11.9 3-5.8 3.6-12.5 1.7-18.7-2-6.3-6.4-11.4-11.8-11.6-11-4.5-23.6 0.9-28.1 11.9-1.9 3.5-2.8 7.4-2.8 11.3z" />
                <path d="m54.7 54.2c0 3.4-0.7 6.7-2.2 9.9-5.5 11.7-19.5 17.1-31.2 11.3-5.7-2.6-10-7.3-12.1-13.2s-0.9-12.2 0.8-17.9c5.5-11.7 19.4-17.1 31.1-11.3 5.7 2.6 10 7.3 12.1 13.2 1 2.6 1.5 5.3 1.5 8zm-46.5 0c0 2.7 0.5 5.3 1.4 7.9 2.1 5.8 6.3 10.4 11.9 13 11.5 5.4 25.3 0.4 30.6-11.1 2.6-5.6 2.9-11.8 0.8-17.6s-6.3-10.4-11.9-13l0.1-0.2-0.1 0.1c-11.5-5.4-25.3-0.4-30.6 11.1-1.5 3.1-2.2 6.5-2.2 9.8z" />
                <path d="m58.7 54.2c0 4-1 7.9-2.8 11.5-6.4 12.2-21.5 16.9-33.6 10.6-6-3.1-10.3-8.3-12.3-14.6s-1.4-13.1 1.7-19c6.3-12.2 21.4-17 33.6-10.6 5.9 3.1 10.3 8.3 12.3 14.6 0.8 2.5 1.1 5 1.1 7.5zm-49.5 0c0 2.5 0.4 5 1.1 7.4 2 6.3 6.3 11.4 12.1 14.4 12 6.3 26.9 1.6 33.1-10.4 3.9-6.3 5.1-13.7 3.4-20.9s-6.3-13.3-12.1-14.4c-13-6.3-26.9-1.6-33.1 10.4-2.6 4.4-4.1 9.4-4.1 14.5z" />
                <path d="m62.9 54.2c0 4.6-1.2 9.1-3.5 13.1-7.3 12.7-23.6 17.1-36.2 9.9-6.1-3.5-10.5-9.2-12.4-16s-0.9-14 2.6-20.1c7.3-12.7 23.5-17.1 36.2-9.8l-0.1 0.2 0.1-0.2c6.1 3.5 10.5 9.2 12.4 16 0.5 2.3 0.9 4.6 0.9 6.9zm-52.7-0.1c0 2.3 0.3 4.6 0.9 6.9 1.8 6.7 6.2 12.3 12.2 15.8 12.5 7.2 28.5 2.9 35.7-9.6 3.5-6.1 4.4-14.1 2.5-19.8-1.8-6.7-6.2-12.3-12.2-15.8-12.5-7.2-28.5-2.8-35.7 9.7-2.2 3.9-3.4 8.3-3.4 12.8z" />
                <path d="m67 54.2c0 5.2-1.4 10.3-4.2 14.8-8.2 13.2-25.5 17.2-38.7 9-6.4-4-10.8-10.2-12.5-17.5s-0.5-14.8 3.5-21.2c8.2-13.2 25.5-17.2 38.7-9 6.4 4 10.8 10.2 12.5 17.5 0.5 2.1 0.7 4.3 0.7 6.4zm-55.9-0.1c0 1.1 0.2 2.1 0.7 3.2 1.7 7.2 6.1 13.3 12.4 17.2 13 8.1 30.1 4.1 38.2-8.9 3.9-6.3 5.1-13.7 3.4-20.9s-6.1-13.3-12.4-17.2c-13-8.1-30.1-4.1-38.2 8.9-2.6 4.4-4.1 9.4-4.1 14.5z" />
                <path d="m71.2 54.2c0 5.8-1.7 11.5-5 16.4-9.1 13.7-27.6 17.4-41.2 8.3-6.6-4.4-11.1-11.1-13-21.7s0-15.7 4.4-22.3c9.1-13.6 27.6-17.4 41.2-8.3 6.6 4.4 11.1 11.1 13 21.7 0.2 1.5 0.3 3.1 0.3 4.8zm-59.1-0.1c0 1.9 0.2 3.9 0.6 5.9 1.5 7.7 6 14.3 12.5 18.6 13.5 9 31.7 5.3 40.7-8.2 4.3-6.5 5.9-14.4 4.3-22-1.5-7.7-6-14.3-12.5-18.6-13.5-9-31.7-5.3-40.7 8.2-3.3 4.8-4.9 10.4-4.9 16.1z" />
                ...
                <path d="m79.6 54.3c0 7.1-2.3 13.9-6.5 19.7-10.9 14.6-31.6 17.7-46.3 6.8-7.1-5.3-12.3-13-13-21.7s0.9-17.4 6.2-24.5c10.9-14.6 31.6-17.7 46.3-6.8 7.1 5.3 12.3 13 13 21.7 0.2 1.5 0.3 3.1 0.3 4.8zm-65.8-0.2c0 1.6 0.1 3.2 0.4 4.8 1.3 8.7 5.8 16.3 12.8 21.5 14.5 10.8 35 7.7 45.7-6.7 5.2-7 7.4-15.6 6.1-24.2s-5.8-16.3-12.8-21.5l0.1-0.1v0.1c-14.5-10.8-35-7.7-45.7 6.7-4.3 5.7-6.6 12.4-6.6 19.4z" />
        ...
        <div className="container ">
            ...
            <div className="row align-items-center g-5">
                ...
                <div className="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                    ...
                    <!-- Title -->
                    <h1 className="mb-0 display-6">{% trans %}MAINMESSAGE_KEY{% endtrans %}
                        <span className="position-relative">{% trans %}FINGERSTIPS_KEY{% endtrans %}
                            <!-- SVG START -->
                    ...
                    <!-- Content -->
                    <p className="my-4 lead">{% trans %}MAINMESSAGEDESCRIPTION_KEY{% endtrans %}</p>
                    
                    <!-- Info -->
                    <ul className="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                        <li className="list-inline-item me-2"> <i className="bi bi-patch-check-fill h6 me-1"></i>{% trans %}LEARNEXPERT_KEY{% endtrans %}</li>
                        <li className="list-inline-item me-2"> <i className="bi bi-patch-check-fill h6 me-1"></i>{% trans %}GETCERTIFICATE_KEY{% endtrans %}</li>
                        <li className="list-inline-item"> <i className="bi bi-patch-check-fill h6 me-1"></i>{% trans %}GETMEMBERSHIP_KEY{% endtrans %}</li>
                    </ul>

                    <div className="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                        <!-- Button -->
                        <a href="{url("app_front_courses")}" className="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">{% trans %}GETSTARTED_KEY{% endtrans %}</a>
                        <!-- Video button -->
                        <div className="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
                            <a  data-bs-toggle="modal" data-bs-target="#coursePremium" href="#" className="btn btn-round btn-primary-shadow mb-0 overflow-visible me-7"> 
                                <i className="fas fa-user"></i>
                                <h6 className="mb-0 ms-3 fw-normal position-absolute start-100 top-50 translate-middle-y">{% trans %}CREATEACCOUNT_KEY{% endtrans %}</h6>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-lg-7 col-xl-6 text-center position-relative">
                    ...
                    <figure className="position-absolute top-50 start-50 translate-middle mt-n7">
                        <svg className="fill-warning">
                            ...
                            <path d="m2.2 15c0.5 0.2 1 0.6 1.4 1 0.5 0.4 1.1 0.8 1.6 1.2 1.2 0.8 2.4 1.7 3.5 2.6 0.3 0.2 0.7 0.3 0.9 0 0.2-0.2 0.3-0.7 0-0.9-1.2-1.1-2.5-1.9-3.8-2.8-0.6-0.4-1.1-0.8-1.6-1.2-0.5-0.5-1.1-0.9-1.7-1.1-0.3-0.1-0.7 0.1-0.8 0.5-0.1 0.2 0.1 0.5 0.5 0.7z" />
                    ...
                    <div className="p-3 bg-blur border border-light shadow rounded-4 position-absolute bottom-0 start-0 z-index-9 d-none d-xl-block mb-5 ms-5">
                        <div className="d-flex justify-content-between align-items-center">
                            ...
                            <div className="text-start ms-3">
                                <h6 className="mb-0 text-white">{% trans %}CONGRATULATION_KEY{% endtrans %} <span className="ms-4"><i className="fas fa-check-circle text-success"></i></span></h6>
                                <p className="mb-0 small text-white">{% trans %}ADMISSIONCOMPLETE_KEY{% endtrans %}</p>
                            </div>
                        </div>
                    </div>

                    <!-- Active student --> 
                    <div className="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style="background:url(assets/images/pattern/01.png) no-repeat center center; background-size:cover;">
                        <p className="text-white">{% trans %}DAILYSTUDENT_KEY{% endtrans %}</p>
                        <!-- Avatar group -->
                        <ul className="avatar-group mb-0">
                            {dailyStudents|length < 4 && (

                                {% for i in dailyStudents|length..3 %}
                                    <li className="avatar avatar-sm">
                                        <div className="avatar-img rounded-circle border-white bg-secondary">
                                            <span className="text-white position-absolute top-50 start-50 translate-middle small"><i className="fas fa-user-graduate"></i></span>
                                        </div>
                                    </li>
                            ...
                            {dailyStudents.map(ds => (

                                <li className="avatar avatar-sm">
                                    {ds.utilisateur is not null and ds.utilisateur.personne is not null && (

                                        <img className="avatar-img rounded-circle border-white" src="{asset(ds.utilisateur.personne.avatarPath)}" alt="avatar" />
                                    
) || (

                                        <img className="avatar-img rounded-circle border-white" src="{asset('assets/images/avatar/avatar.png')}" alt="avatar" />
