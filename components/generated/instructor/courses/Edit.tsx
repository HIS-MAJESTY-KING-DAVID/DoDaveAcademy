...
{% block instructorBanner %}
	...
	<!-- =======================
	    Page Banner START -->
	<section
		className="py-0 bg-blue h-100px align-items-center d-flex h-200px rounded-0" style="background:url({asset('assets/images/pattern/04.png')}) no-repeat center center; background-size:cover;">
		...
		<div className="container">
			<div className="row">
				<div
					...
					<!-- Title -->
					<h1 className="text-white">{pageTitle|default('Submit a new Course')|raw}</h1>
				</div>
			</div>
		</div>
	</section>
...
{% block pageContent %}
	...
	<section>
		<div className="container">
			...
			<div className="card bg-transparent border rounded-3 mb-5">
				<div
					id="stepper" className="bs-stepper stepper-outline">
					<!-- Card header -->
					<div
						className="card-header bg-light border-bottom px-lg-5">
						<!-- Step Buttons START -->
						<div
					...
					<div
						...
						<div className="bs-stepper-content">
							...
							<div
								id="step-1" role="tabpanel" className="content fade" aria-labelledby="steppertrigger1">
								<!-- Title -->
								...
								<!-- Basic information START -->
									<div
									className="row g-4"> <!-- Course title -->
							...
							<div
								id="step-2" role="tabpanel" className="content fade" aria-labelledby="steppertrigger2">
								<!-- Title -->
								<h4>Course media</h4>
								...
								<div
									...
									<div className="col-12">
										<div
											className="text-center justify-content-center align-items-center p-4 p-sm-5 border border-2 border-dashed position-relative rounded-3">
											<!-- Image -->
											{cours.media is null && (
												...
												<img src="{asset('uploads/media/courses/' ~ cours.media.imageFile)}" className="h-50px" alt="" />
											
)}

											<div>
												<h6 className="my-2">Upload course image here, or<a href="#!" className="text-primary">
														Browse</a>
												</h6>
							...
							<div
								id="step-3" role="tabpanel" className="content fade" aria-labelledby="steppertrigger3">
								<!-- Title -->
								<h4>Curriculum</h4>
								...
								<div
									...
									<div className="d-sm-flex justify-content-sm-between align-items-center mb-3">
										...
										<a href="#" className="btn btn-sm btn-primary-soft new-chapitre mb-0" data-bs-toggle="modal" data-bs-target="#addLecture">
											<i className="bi bi-plus-circle me-2"></i>Add Chapiter</a>
									</div>

									<!-- Edit lecture START -->
									<div className="accordion accordion-icon accordion-bg-light chapiters" id="accordionExample2" data-index="{form.chapitres|length > 0 ? form.chapitres|last.vars.name + 1 : 0}" data-prototype="{form_widget(form.chapitres.vars.prototype)|e('html_attr')}">
							...
							<div
								id="step-4" role="tabpanel" className="content fade" aria-labelledby="steppertrigger4">
								<!-- Title -->
									...
									<div className="col-12">
										<div className="bg-light border rounded p-2 p-sm-4">
											<div className="d-sm-flex justify-content-sm-between align-items-center mb-3">
												...
												<a href="#" className="btn btn-sm btn-primary-soft mb-0" data-bs-toggle="modal" data-bs-target="#addQuestion">
													<i className="bi bi-plus-circle me-2"></i>Add Question</a>
											</div>
											<div className="row g-4" id="faqs" data-index="{form.fAQs|length > 0 ? form.fAQs|last.vars.name + 1 : 0}" data-prototype="{form_widget(form.fAQs.vars.prototype)|e('html_attr')}">
												{% set index = 0 %}
		...
		<div className="modal-dialog">
			<div className="modal-content">
				<div className="modal-header bg-dark">
					<h5 className="modal-title text-white" id="addLectureLabel">Add Chapter</h5>
				...
				<div className="modal-body">
					<form
						className="row text-start g-3">
						<!-- Course name -->
						<div className="col-12">
							<label className="form-label">Chapter title
						...
						<!-- Course name -->
						<div className="col-12">
							<label className="form-label">Chapter Number
								<span className="text-danger">*</span>
							</label>
							<input type="number" min="1" id="chapiter_number" className="form-control" placeholder="Enter chapter number" />
						</div>
						<!-- Course name -->
						<div className="col-12">
							<label className="form-label">Chapter description
								<span className="text-danger">*</span>
							</label>
	...
	<div className="modal modal-lg fade" id="addTopic" tabindex="-1" aria-labelledby="addTopicLabel" aria-hidden="true">
		<div className="modal-dialog">
			<div className="modal-content">
				<div className="modal-header bg-dark">
					<h5 className="modal-title text-white" id="addTopicLabel">Add Lesson</h5>
					<button type="button" className="btn btn-sm btn-light mb-0" data-bs-dismiss="modal" aria-label="Close">
						<i className="bi bi-x-lg"></i>
					</button>
				</div>
				<form id="lessonForm" className="row text-start g-3" method="post" action="{path('app_lesson_edit', {'id': '__ID__'})}">
					...
					<div className="modal-body">
						...
						<div className="col-md-12">
							<div id="uploadFilesDiv" className="d-none">
								<div className="row">
									<div className="col-md-6">
										<label className="form-label">Video File</label>
										<div style="position: relative">
											<label style="cursor:pointer;" for="" id="addLessonVideoFileLabel" className="d-block">
												<span>
													<div className="custom-file">
														<div className="form-control stretched-link custom-file-input">
															<label className="custom-file-label">Upload video file</label>
														</div>
													</div>
												</span>
											</label>
									...
									<div className="col-md-6">
										...
										<div style="position: relative">
											<label style="cursor:pointer;" for="" id="addLessonPosterFileLabel" className="d-block">
												<span>
													<div className="custom-file">
														<div className="form-control stretched-link custom-file-input">
															<label className="custom-file-label">Upload poster file</label>
														</div>
													</div>
												</span>
											</label>
						...
						<div className="col-6 mt-3">
							<div
								className="btn-group" role="group" aria-label="Basic radio toggle button group">
								<!-- Free button -->
					...
					<div className="modal-footer">
						...
						<button type="submit" data-index="" data-title-reference="" data-chapiter="" data-prototype-container="" className="btn btn-success my-0 " style="display: none;" id="editLessonBtn">Update lesson</button>
						<!--  <button type="submit" data-index="" data-title-reference="" data-chapiter="" data-prototype-container="" className="btn btn-success my-0 edit_lesson_btn" style="display: none;" id="editLessonBtn">Update lesson</button>
						        -->
					</div>
				</form>
			</div>
