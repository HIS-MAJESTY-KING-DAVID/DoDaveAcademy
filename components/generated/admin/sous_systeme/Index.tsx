...
{% block actionBtn %}
	<a data-bs-toggle="modal" data-bs-target="#addCategoryModal" href="#" className="btn btn-sm btn-primary mb-0">Add Sous system</a>
{% endblock %}
					...
					<tbody>
						{sous_systemes.map(ss => (
							...
							<tr>
								...
								<td>
									<div className="d-flex align-items-center position-relative">
										...
										<h6 className="table-responsive-title mb-0 ms-2">	
											<a href="" className="stretched-link">{ss.name}</a>
										</h6>
									</div>
								</td>
								...
								<!-- Table data -->
								<td>
									<a data-url="{path('app_admin_sous_systeme_edit', {id: ss.id})}" href="#" className="btn btn-sm btn-success-soft edit_category_btn me-1 mb-1 mb-md-0">Edit</a>
                                    {include('admin/sous_systeme/_delete_form.html.twig', {sous_systeme: ss})}
								</td>
							</tr>
