...
{% block actionBtn %}
	<a data-bs-toggle="modal" data-bs-target="#addModal" href="#" className="btn btn-sm btn-primary mb-0">Add Speciality</a>
{% endblock %}
		...
		<div className="card-body">
			...
			<div className="table-responsive border-0 rounded-3">
				...
				<table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
					...
					<thead>
						<tr>
							<th scope="col" className="border-0 rounded-start">Speciality Name</th>
							<th scope="col" className="border-0">Filiere</th>
                            <th scope="col" className="border-0">Classes</th>
					...
					<tbody>
						{specialites.map(specialite => (
							...
							<tr>
								...
								<td>
									<div className="d-flex align-items-center position-relative">
										...
										<h6 className="table-responsive-title mb-0 ms-2">	
											<a href="" className="stretched-link">{specialite.name}</a>
										</h6>
									</div>
								</td>
								...
								<!-- Table data -->
								<td>
									<a data-url="{path('app_admin_specialite_edit', {id: specialite.id})}" href="#" className="btn btn-sm btn-success-soft edit_with_modal_btn me-1 mb-1 mb-md-0">Edit</a>
