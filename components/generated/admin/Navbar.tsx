        ...
        <div className="d-flex align-items-center w-100">
            ...
            <div className="d-flex align-items-center d-xl-none">
                <a className="navbar-brand" href="{path('app_front')}">
                    <img className="light-mode-item navbar-brand-item h-30px" src="{asset('assets/images/logo-mobile.svg')}" alt="" />
                    <img className="dark-mode-item navbar-brand-item h-30px" src="{asset('assets/images/logo-mobile-light.svg')}" alt="" />
                </a>
            </div>
            <!-- Logo END -->
                                    ...
                                    <ul className="list-group list-unstyled list-group-flush">
                                        ...
                                        <li>
                                            <a href="#" className="list-group-item-action border-0 border-bottom d-flex p-3">
                                                <div className="me-3">
                                                    <div className="avatar avatar-md">
                                                        <img className="avatar-img rounded-circle" src="{asset('assets/images/avatar/02.jpg')}" alt="avatar" />
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <li>
                                            <a href="#" className="list-group-item-action border-0 border-bottom d-flex p-3">
                                                <div className="me-3">
                                                    <div className="avatar avatar-md">
                                                        <img className="avatar-img rounded-circle" src="{asset('assets/images/avatar/05.jpg')}" alt="avatar" />
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <li>
                                            <a href="#" className="list-group-item-action border-0 border-bottom d-flex p-3">
                                                <div className="me-3">
                                                    <div className="avatar avatar-md">
                                                        <img className="avatar-img rounded-circle" src="{asset('assets/images/avatar/03.jpg')}" alt="avatar" />
                                                    </div>
                                                </div>
                                                <div>
                        ...
                        <ul className="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                            ...
                            <li className="px-3">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div>
                                        <a className="h6 mt-2 mt-sm-0" href="#">{app.user.personne.pseudo}</a>
                                        <p className="small m-0">{app.user.email}</p>
                                    </div>
                                </div>
                            </li>
                            <li> <hr className="dropdown-divider" /></li>
                            <!-- Links -->
                            <li><a className="dropdown-item" href="{url("app_profile", parameters = [], schemeRelative = false)}"><i className="bi bi-person fa-fw me-2"></i>Edit Profile</a></li>
                            <li><a className="dropdown-item" href="{url("app_admin_setting")}"><i className="bi bi-gear fa-fw me-2"></i>Site Settings</a></li>
                            <li><a className="dropdown-item" href="#"><i className="bi bi-info-circle fa-fw me-2"></i>Help</a></li>
                            <li><a className="dropdown-item bg-danger-soft-hover" href="{url("app_logout")}"><i className="bi bi-power fa-fw me-2"></i>Sign Out</a></li>
                            <li> <hr className="dropdown-divider" /></li>
