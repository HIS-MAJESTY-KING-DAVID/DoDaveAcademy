...
{% block actionBtn %}
	<a data-bs-toggle="modal" data-bs-target="#addModal" href="#" className="btn btn-sm btn-primary mb-0">Add Class</a>
{% endblock %}
				...
				<table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
					...
					<thead>
						<tr>
							...
							<th scope="col" className="border-0">Speciality</th>
					...
					<tbody>
						{classes.map(classe => (
							...
							<tr>
								...
								<td>
									<div className="d-flex align-items-center position-relative">
										...
										<h6 className="table-responsive-title mb-0 ms-2">	
											<a href="" className="stretched-link">{classe.name}</a>
										</h6>
									</div>
								</td>
								...
								<!-- Table data -->
								<td>
									<a data-url="{path('app_admin_classe_edit', {id: classe.id})}" href="#" className="btn btn-sm btn-success-soft edit_with_modal_btn me-1 mb-1 mb-md-0">Edit</a>
