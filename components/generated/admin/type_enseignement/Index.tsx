...
{% block actionBtn %}
	<a data-bs-toggle="modal" data-bs-target="#addCategoryModal" href="#" className="btn btn-sm btn-primary mb-0">Add new</a>
{% endblock %}
					...
					<tbody>
						{type_enseignements.map(te => (
							...
							<tr>
								...
								<td>
									<div className="d-flex align-items-center position-relative">
										...
										<h6 className="table-responsive-title mb-0 ms-2">	
											<a href="" className="stretched-link">{te.name}</a>
										</h6>
									</div>
								</td>
								...
								<!-- Table data -->
								<td>
									<a data-url="{path('app_admin_type_enseignement_edit', {id: te.id})}" href="#" className="btn btn-sm btn-success-soft edit_with_modal_btn me-1 mb-1 mb-md-0">Edit</a>
