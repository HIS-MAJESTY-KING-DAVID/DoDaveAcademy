...
{% block actionBtn %}
	<a data-bs-toggle="modal" data-bs-target="#addModal" href="#" className="btn btn-sm btn-primary mb-0">Add Filiere</a>
{% endblock %}
		...
		<div className="card-body">
			...
			<div className="table-responsive border-0 rounded-3">
				...
				<table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
					...
					<thead>
						<tr>
							<th scope="col" className="border-0 rounded-start">Filiere Name</th>
							<th scope="col" className="border-0">Specialties</th>
                            <th scope="col" className="border-0">Type d'enseignement</th>
                            <th scope="col" className="border-0">Sous-system</th>
							...
							<tr>
								...
								<td>
									<div className="d-flex align-items-center position-relative">
										...
										<h6 className="table-responsive-title mb-0 ms-2">	
											<a href="" className="stretched-link">{filiere.name}</a>
										</h6>
									</div>
								</td>
                                ...
                                <td>
                                    {% for ss in filiere.sousSystemes %}
                                        <span className="badge badge-info">{ss.name}</span>
								...
								<!-- Table data -->
								<td>
									<a data-url="{path('app_admin_filiere_edit', {id: filiere.id})}" href="#" className="btn btn-sm btn-success-soft edit_with_modal_btn me-1 mb-1 mb-md-0">Edit</a>
