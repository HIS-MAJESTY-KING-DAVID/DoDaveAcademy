...
export default function DeleteForm(props: any) {
  return (
    <>
<form method="post" style="display: inline;" action="{path('app_admin_filiere_delete', {'id': filiere.id})}" onsubmit="return confirm('Are you sure you want to delete this item?');">
