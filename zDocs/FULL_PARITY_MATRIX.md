...
>
> **Current behavioral parity score: 57% (2026-08-25).** This conservative score covers 21 capability groups and weights full parity as 1 point, partial/unverified parity as 0.5 points, and missing/unconfirmed parity as 0 points. The score increased because the learner subject-chat room workflow and admin recursive content slice are now partially implemented. See `FEATURE_PARITY_PRODUCTION_READINESS.md` for the calculation and remaining gaps.
>
...
| Admin learning CRUD | Chapters, lessons, quizzes, propositions, media | Admin course content page plus chapter/lesson creation APIs | Partial parity now implemented | Add edit/delete, quiz/proposition/media management, and full recursive acceptance. |
