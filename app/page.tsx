        ...
        <div className="container position-relative">
          <div className="row">
            <div className="col-12">
              <div className="bg-primary p-4 p-sm-5 rounded-4 overflow-hidden position-relative">
                 {/* Decorative element */}
                 <div className="position-absolute top-0 end-0 mt-n4 me-n4 d-none d-lg-block">
                    <div className="bg-white opacity-10 rounded-circle" style={{width: '200px', height: '200px'}}></div>
                 </div>
                 
                <div className="row position-relative align-items-center">
                  <div className="col-lg-7">
                    <h3 className="text-white mb-3 display-6">{t('BECOMEINSTRUCTOR_KEY')}</h3>
                    <p className="text-white text-opacity-75 mb-4 lead">{t('BECOMEINSTRUCTORDESCRIPTION_KEY')}</p>
                    <Link href="/become-teacher" className="btn btn-warning btn-lg mb-0 text-dark fw-bold">
                        {t('STARTTEACHINGTODAY_KEY')}
                    </Link>
                  </div>
