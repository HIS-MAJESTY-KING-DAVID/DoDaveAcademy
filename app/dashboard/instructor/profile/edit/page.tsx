      ...
      .then((d) => {
        if (d.data?.person) {
          ...
          setForm({
            ...
            address: p.address || '',
            gender: p.gender || 'M',
            aboutMe: d.data?.instructor?.aboutMe || '',
          });
        }
        setLoading(false);
      })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/profile', {
        ...
        body: JSON.stringify({
          ...form,
          aboutMe: form.aboutMe, // Will be passed through for instructor
        }),
      });
  ...
  return (
    <div className="container py-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <Link href="/dashboard/instructor/profile" className="btn btn-outline-secondary">Cancel</Link>
      </div>
        ...
        <div className="card-body p-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <textarea className="form-control" rows={5} value={form.aboutMe} onChange={(e) => setForm({ ...form, aboutMe: e.target.value })} />
            </div>
